...
File 1-print_rev_recursion.c is a function that prints a  reverse string. 
...
File 4-pow_recursion.c is a function that returns the value of x to the power of y.
